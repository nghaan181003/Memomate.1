...
//        LibraryFragment libraryFragment = (LibraryFragment) fragmentManager.findFragmentByTag("android:switcher:" + R.id.view_pager + ":" + studySetViewPager.getCurrentItem());
//        if (libraryFragment != null) {
//            libraryFragment.switchToTab(position);
//        }
...
//    private ArrayList<StudySet> getStudySetData(){
//        ArrayList<StudySet> data = new ArrayList<>();
...
//
//
//        data.add(new StudySet("Hello", R.drawable.images, "thanhhoa1", flashCards1));
//        data.add(new StudySet("Hello", R.drawable.images, "thanhhoa1",flashCards1));
//        data.add(new StudySet("Hello", R.drawable.images, "thanhhoa2",flashCards2));
//        data.add(new StudySet("Hello", R.drawable.images, "thanhhoa3",flashCards2));
//        return data;
//    }
